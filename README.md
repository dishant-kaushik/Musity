...
![Song Recommendations](Screenshot%202025-06-02%20at%2012.05.13%20PM.png)
...
1. **Launch the Application**: Run `streamlit run app.py` to start the web interface.
2. **Enter a Song**: Type the name of a song you like in the input field.
3. **Get Recommendations**: The system will display 5 similar songs with their album covers.
4. **Listen on YouTube**: Click the provided YouTube links to listen to the recommended songs.
